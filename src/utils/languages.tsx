...
const aboutPortfolioEn = `A basic project that posed various challenges and provided significant learning opportunities. 
Created entirely from scratch without any templates, I chose to use tools like TypeScript and React, 
which were not strictly necessary but allowed me to enhance my knowledge of these technologies.`

const aboutCosmoPt = `Projeto feito em grupo com outros devs Jrs também em início de carreira, este é eu projeto mais ambicioso até o momento. 
Construido inteiramente do zero e utilizando tecnologias que nunca havia estudado antes (React Native e frameworks),
 criamos uma integração entre front e back, aplicamos Arquiteturas em Camadas MSC (Model-Service-Controller), 
 metodos de autenticação, conhecimento da estrutura Dockerfile e docker-compose, banco de dados não relacional (Mongo)...`

const aboutCosmoEn = ''

const aboutAlgorithmsPt = `Uma aplicação web simples mas poderosa, que utiliza um exepcional algoritmo de ordenação. 
Insira um valor e pressione o botão para ver o Merge Sort em ação.`

const aboutAlgorithmsEn = `A simple yet powerful web application that utilizes a robust sorting algorithm.
Enter a value and press the button to see the Merge Sort in action.`
...
export const portuguese = {
  ...
  projects: {
    aboutPortfolio: aboutPortfolioPt,
    aboutAlgorithms: aboutAlgorithmsPt,
    aboutPixelArt: aboutPixelArtPt,
...
export const english = {
  ...
  projects: {
    aboutPortfolio: aboutPortfolioEn,
